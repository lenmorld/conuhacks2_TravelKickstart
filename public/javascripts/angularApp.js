...
app.factory('travelService', ['$http', function ($http) {
    ...
    o.getAll = function () {
        ...
        // get all travels which is a route provided by our own Node REST API
        $http.get('/travels').success(function(data) {
            angular.copy(data, o.travels);
        }) ;

        // !!!!  IMPORTANT TODO - Auth.header RE-GENERATE EVERY HOUR     !!!!!!!!!!
        ...
        // get all products which is an external route provided by SAP YaaS
